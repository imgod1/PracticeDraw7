    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe startKeyframe = Keyframe.ofFloat(0, 0);
                Keyframe centerKeyframe = Keyframe.ofFloat(0.5f, 100);
                Keyframe endKeyframe = Keyframe.ofFloat(1, 80);

                PropertyValuesHolder holder = PropertyValuesHolder.ofKeyframe("progress", startKeyframe, centerKeyframe, endKeyframe);
